            ...
            <div className="flex items-center space-x-3">
              {!showWelcome && (
                <button
                  ...
                  className="group flex items-center space-x-3 px-3 sm:px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-gray-50 dark:hover:bg-gray-750 bg-gray-100 dark:bg-gray-700 rounded-xl transition-all duration-200 ease-out"
                >
