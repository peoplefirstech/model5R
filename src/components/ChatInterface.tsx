            ...
            <div className="flex items-center space-x-3">
              {!showWelcome && (
                <button
                  ...
                  className="group flex items-center space-x-2 px-3 sm:px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-gray-50 dark:hover:bg-gray-750 bg-gray-100 dark:bg-gray-700 rounded-xl transition-all duration-200 ease-out"
                >
                ...
                >
                  <div className={`flex items-start space-x-3 sm:space-x-4 ${
                    message.sender === 'user' 
                     ...
                     : 'space-x-6 sm:space-x-8 max-w-4xl'
                  }`}>
