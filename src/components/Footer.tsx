          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-300 text-sm font-medium">Coach Virtuel IA • Modèle 5R®</p>
              </div>
            </div>
            
            <p className="text-xl font-semibold bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">
              {t.tagline}
            </p>
            ...
            <div className="flex space-x-3">
              <a href="#" className="group p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">
                <Linkedin className="w-5 h-5 text-purple-300 group-hover:text-purple-200 transition-colors duration-300" />
              </a>
              <a href={`mailto:${t.email}`} className="group p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">
                <Mail className="w-5 h-5 text-purple-300 group-hover:text-purple-200 transition-colors duration-300" />
              </a>
              <a href={`tel:${t.phone}`} className="group p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">
                <Phone className="w-5 h-5 text-purple-300 group-hover:text-purple-200 transition-colors duration-300" />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a href={`mailto:${t.email}`} className="group flex items-center text-gray-300 hover:text-white transition-all duration-300 p-3 rounded-xl hover:bg-white/5">
                <div className="w-10 h-10 bg-purple-500/20 rounded-xl flex items-center justify-center mr-4 group-hover:bg-purple-500/30 transition-colors duration-300">
              ...
              <div className="group flex items-start text-gray-300 p-3 rounded-xl">
                <div className="w-10 h-10 bg-purple-500/20 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                  <MapPin className="w-4 h-4 text-purple-400" />
                </div>
                <span className="text-sm font-medium leading-relaxed">{t.address}</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 rounded-xl text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300"
                />
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-purple-500/25">
      ...
      <div className="relative border-t border-white/10 dark:border-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            {/* Legal Links */}
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center space-y-3 sm:space-y-0 sm:space-x-8 text-sm">
              <Link 
                to="/mentions-legales"
                className="group flex items-center text-gray-300 hover:text-white transition-all duration-300 whitespace-nowrap px-3 py-2 rounded-lg hover:bg-white/5"
              >
                <FileText className="w-4 h-4 mr-2 text-purple-400 group-hover:text-purple-300 transition-colors duration-300" />
                {t.legal}
              </Link>
              ...
              <Link 
                ...
                className="group flex items-center text-gray-300 hover:text-white transition-all duration-300 whitespace-nowrap px-3 py-2 rounded-lg hover:bg-white/5"
              >
                <Shield className="w-4 h-4 mr-2 text-purple-400 group-hover:text-purple-300 transition-colors duration-300" />
                {t.privacy}
              </Link>
              ...
              <Link 
                ...
                className="group flex items-center text-gray-300 hover:text-white transition-all duration-300 whitespace-nowrap px-3 py-2 rounded-lg hover:bg-white/5"
              >
                <Cookie className="w-4 h-4 mr-2 text-purple-400 group-hover:text-purple-300 transition-colors duration-300" />
                {t.cookies}
              </Link>
            </div>
