          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className={`group ${!isMobile ? 'animate-slideUp' : ''}`} style={{ animationDelay: '0.1s' }}>
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 border-2 border-blue-300/60 dark:border-blue-500/60 h-full transition-all duration-300 hover:border-blue-400/80 dark:hover:border-blue-400/80 hover:shadow-xl hover:shadow-blue-500/15 dark:hover:shadow-blue-500/25 hover:-translate-y-2 shadow-lg">
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/40 dark:to-blue-800/40 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg transition-all duration-300">
              ...
              <div className={`group ${!isMobile ? 'animate-slideUp' : ''}`} style={{ animationDelay: '0.2s' }}>
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 border-2 border-purple-300/60 dark:border-purple-500/60 h-full transition-all duration-300 hover:border-purple-400/80 dark:hover:border-purple-400/80 hover:shadow-xl hover:shadow-purple-500/15 dark:hover:shadow-purple-500/25 hover:-translate-y-2 shadow-lg">
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg transition-all duration-300">
              ...
              <div className={`group ${!isMobile ? 'animate-slideUp' : ''}`} style={{ animationDelay: '0.3s' }}>
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 border-2 border-emerald-300/60 dark:border-emerald-500/60 h-full transition-all duration-300 hover:border-emerald-400/80 dark:hover:border-emerald-400/80 hover:shadow-xl hover:shadow-emerald-500/15 dark:hover:shadow-emerald-500/25 hover:-translate-y-2 shadow-lg">
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg transition-all duration-300">
