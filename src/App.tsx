...
function App() {
  ...
  const PresentationPage = () => (
    <div className={`min-h-screen transition-colors duration-300 ${themeClasses.bg} ${themeClasses.text}`}>
      ...
      <header className={`relative z-50 ${isDarkMode ? 'bg-black/95' : 'bg-white/95'} backdrop-blur-xl border-b sticky top-0 ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={toggleTheme}
                className={`p-3 rounded-lg transition-all duration-300 ${isDarkMode ? 'text-white hover:bg-white/10' : 'text-gray-800 hover:bg-gray-100'}`}
              >
              ...
              <button
                ...
                className={`inline-flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-300 ${isDarkMode ? 'text-white hover:bg-white/10' : 'text-gray-800 hover:bg-gray-100'}`}
              >
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-3 text-sm font-medium text-gray-800 rounded-lg transition-all duration-300 hover:bg-gray-100"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
  ...
  const ChatPage = () => (
    <div className={`min-h-screen transition-colors duration-300 ${themeClasses.bg} ${themeClasses.text}`}>
      ...
      <header className={`${isDarkMode ? 'bg-black/95' : 'bg-white/95'} backdrop-blur-xl border-b sticky top-0 z-50 ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <button
                onClick={() => setCurrentPage('presentation')}
                className={`p-3 rounded-lg transition-all duration-300 ${isDarkMode ? 'text-gray-400 hover:text-white hover:bg-white/10' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-100'}`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
